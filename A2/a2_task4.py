...
sys.stdout = Logger(task_dir + '/task4'+cur_time+'.log')
...
def model(tf_val, l1_weights, l1_biases, l2_weights, l2_biases, l3_weights, l3_biases):
    logits1 = tf.matmul(tf_val/255., l1_weights) + l1_biases
    hidden1 = tf.nn.relu(logits1)
    logits2 = tf.matmul(hidden1, l2_weights) + l2_biases
    hidden2 = tf.nn.relu(logits2)
    return tf.matmul(hidden2, l3_weights) + l3_biases


### get the model evaluation
def modelEval(l1_weights, l1_biases, l2_weights, l2_biases, l3_weights, l3_biases, tf_dataset, tf_labels):
    logits = model(tf_dataset, l1_weights, l1_biases, l2_weights, l2_biases, l3_weights, l3_biases)
...
# at run time with a training minibatch.
    ...
    train_logits, train_pred, train_loss, train_log = modelEval(layer1_weights, layer1_biases, layer2_weights, layer2_biases, layer3_weights, layer3_biases, x, y)
    ...
    valid_logits, valid_pred, valid_loss, valid_log = modelEval(layer1_weights, layer1_biases, layer2_weights, layer2_biases, layer3_weights, layer3_biases, tf_valid_dataset, tf_valid_labels)
    test_logits, test_pred, test_loss, test_log = modelEval(layer1_weights, layer1_biases, layer2_weights, layer2_biases, layer3_weights, layer3_biases, tf_test_dataset, tf_test_labels)
